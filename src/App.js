    ...
    <ScrollReveal
      ...
      children={() => (
        <Switch>
          ...
          <AppRoute
            exact
            path="/table/familyMember"
            component={ProfileFamilyMember}
            layout={LayoutDefault}
          />
          <AppRoute
            exact
            path="/table/familyMember/submit"
            component={FamilyMemberSubmit}
            layout={LayoutDefault}
          />
          ...
          <AppRoute
            exact
            path="/ChatPage"
            component={ChatPageDisplay}
            layout={LayoutDefault}
          />
          <AppRoute
            exact
            path="/SelectPsychologist"
            component={SelectPsychologist}
            layout={LayoutDefault}
          />
          <AppRoute
            exact
          ...
          <AppRoute
            exact
            path="/table/emergencyContact"
            component={ProfileEmergencyContact}
            layout={LayoutDefault}
          />
          <AppRoute
            exact
            path="/table/emergencyContact/submit"
            component={EmergencyContactSubmit}
            layout={LayoutDefault}
          />
          <AppRoute
            path="/PsychologistProfile/:id"
            component={PsychologistProfile}
            layout={LayoutDefault}
          ></AppRoute>
          <AppRoute
            exact
            path="/table/profileData/submit"
