            ...
            <div style={{backgroundColor: "#25282C"}}>
                ...
                <div className="row col-md-12 mb-5">
                    ...
                    <div className="col-md-4">
                        <input type="text" onChange={e => setAgeofinterest(e.target.vale)}
                               className="form-control border-primary" placeholder="Min Age."></input>
                    </div>
                    <div className="col-md-4">
                        <input type="text" onChange={e => setAgeofinterest(e.target.value)}
                               className="form-control border-primary" placeholder="Max"></input>
                    </div>
                </div>
                ...
                <div className="row col-md-12 mb-5">
                    ...
                    <div className="col-md-9">
                        ...
                        <div className="col-md-9">
                            <input type="text" onChange={e => setHighschool(e.target.value)}
                                   className="form-control border-primary"></input>
                        </div>
                        ...
                        <div className="col-md-9">
                            <input type="text" onChange={e => setMaster(e.target.value)}
                                   className="form-control border-primary"></input>
                        </div>
                    </div>
                </div>
                ...
                <div className="row col-md-12 mb-5">
                    ...
                    <div className="col-md-9">
                        <input type="text" onChange={e => setTitles(e.target.value)}
                               className="form-control border-primary"></input>
                    </div>
                </div>
                ...
                <div className="row col-md-12 mb-5">
                    ...
                    <div className="col-md-9">
         <textarea id="w3review" onChange={e => setBiography(e.target.value)} name="w3review" rows="4"
