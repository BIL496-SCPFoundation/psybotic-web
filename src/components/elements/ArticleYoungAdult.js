...
const ArticleYoungAdult = ({
  ...
  useEffect(() => {
    ...
    if (articles.length < 1) {
      articleService.getYoungAdultArticles().then((res) => {
...
ArticleYoungAdult.propTypes = propTypes;
ArticleYoungAdult.defaultProps = defaultProps;

export default ArticleYoungAdult;
